...
const contentData = {
    ...
    'ring-air': {
        ...
        content: `
            <h3>Dead on Arrival (DOA)</h3>
            <h4>Case Identifier</h4>
            <p>The user is trying to pair their new ring: The ring is experiencing an issue with starting up and pairing.</p>

            <h4>Resolution Steps</h4>
            <h5>STEP 1: Charger Test</h5>
            <p>Macro [Ring_Charger_Test]</p>
            <ul>
                <li>Confirm adapter type (≤20W, <2A)</li>
                <li>Test charging cable with other devices</li>
                <li>Check if charging dock LED turns purple without ring</li>
                <li>Check if LED changes to breathing white with ring placed</li>
                <li>If not breathing white, replace charger</li>
            </ul>

            <h5>STEP 2: Tap Flow</h5>
            <p>Macro [Tap_flow_with_LED]</p>
            <ol>
                <li>Place ring on charger for 30 seconds</li>
                <li>Gently tap ring on table (20-30 times)</li>
                <li>Wait for red LED to turn off, then green LED to appear</li>
                <li>Open app and attempt to connect</li>
            </ol>

            <h5>STEP 3: New Ring Setup Flow</h5>
            <p>Macro [New_Set_up_new_ring]</p>
            <ol>
                <li>Unpair ring from Bluetooth settings</li>
                <li>Toggle Bluetooth off/on</li>
                <li>Restart phone, reopen app</li>
                <li>Tap 'Connect Ring' from Home tab</li>
                <li>Test with different cable/adapter if needed</li>
            </ol>

            <h5>STEP 4: Ring Replacement</h5>
            <p>If all steps fail, escalate to ring replacement.</p>

            <h3>Troubleshooting Top Cases</h3>
            <h4>Ring Not Syncing</h4>
            <p>Check Bluetooth connection, app permissions, and device compatibility.</p>

            <h4>Low Battery Issues</h4>
            <p>Ensure proper charging setup and cable compatibility.</p>

            <h4>Firmware Update Problems</h4>
            <p>Keep app updated, ensure stable internet connection during updates.</p>

            <h4>Comfort and Fit Issues</h4>
            <p>Check ring size, ensure proper cleaning and maintenance.</p>

            <h3>Ring Not Charging</h3>
            <h4>Case Identifier</h4>
            <p>The charger is working fine for the user, but the ring is not detecting the charge and picking up battery.</p>

            <h4>Resolution</h4>
            <p>Step 1: Ring charger test</p>
            <p>We check the Fit of the ring to ensure that the sensors are oriented properly</p>
            <p>Macro: [#Ring_charger_test]</p>
            <ul>
                <li>Could you please confirm the type of adapter that you are using with the charging dock (Brand name and whether it is a normal or fast charger)? The adapter should be within 20 watts and less than 2 AMPS. Please attach images of the adapter for reference.</li>
                <li>Have you tested the charging cable with other devices to confirm its functionality? If possible, try using a different cable to rule out cable issues.</li>
                <li>When you switch on the charging dock without placing the ring on it, does the LED light turn purple?</li>
                <li>When you place the ring on the charging dock, does the LED light on the dock change to a breathing white light? If not, please flip the ring and observe the LED colour.</li>
            </ul>
            <p>This information will help us narrow down the potential causes of the charging issue and provide more targeted solutions.</p>
            <p>Step 2: If the charger is deemed to be faulty we replace the charger</p>
            <p>If the charger is working fine, we move ahead with the next steps</p>
            <p>Step 3: Check for Damage on the Ring's Hardware</p>
            <p>If the charger is confirmed to be working fine, we ask the user to check for any visible damage on the ring around its sensors and request relevant images for further assessment.</p>
            <p>Step 4:</p>
            <ul>
                <li>A: In case of observed hardware damage, replace the ring under hardware damage reasoning.</li>
                <li>B: In case there are no observed damages, replace the ring under battery failure reasoning.</li>
            </ul>

            <h3>Ring Battery- High drain</h3>
            <h4>Case Identifier</h4>
            <p>When the ring's battery drains rapidly: The battery lasts less than 4 days and requires frequent charging - this means the battery drain is MORE THAN 25% per day.</p>
            <p>General macro - battery_service_sop</p>

            <h4>Resolution</h4>
            <p>Route the user to the Battery Troubleshooting Wizard</p>
            <p>FALLBACK STEPS</p>
            <p>Step 1: Review ring data</p>
            <p>Macro: [#BDR_STEP1]</p>
            <p>Thank you for reaching out! We're here to solve this for you. To help you better, we'll review your ring's data and follow up shortly with the next steps. Please allow us some time to get back here.</p>
            <p>Things to be reviewed: Firmware version, battery state graph (dissipation Rate), CDT (High/Low), reset history</p>
            <p>Step 2: Upgrade Firmware (to the latest firmware)</p>
            <p>Macro: [#Pushto_Zephyr]</p>
            <p>I have pushed the latest firmware to your ring. Please quit the app completely, and reopen the app in a while. If you don't see the Firmware Update pop-up, it should appear within the next few hours (If it doesn't, please head to ring battery view > scroll down > "check for firmware update"). Once it does, follow the prompts and update your firmware. Once your firmware has been updated, please observe for a while. You shouldn't face these issues anymore :)</p>
            <p>Let us know how this goes or if you need any help!</p>
            <p>Once the user gets back, we move to the next step.</p>
            <p>Step 3: Factory reset</p>
            <p>Macro: Zephyr_New_FR</p>
            <p>Please go ahead and factory reset your ring here (Ring battery view > scroll down > factory reset > follow the prompts). Once this is done, keep the ring on the charger and you will notice a green LED light when the ring is placed on the charger. At this point, the ring will disconnect from the phone which is expected behaviour so don't worry! Once you see the green light, remove the ring from the charger and connect the ring.</p>
            <p>You can click here and view the process to factory reset the ring.</p>
            <p>After this reset, we need to enable Chill mode.</p>
            <p>Step 4: Enable "Chill mode" and keep it on for at least 48 hours</p>
            <p>Macro: chill_mode_enable</p>
            <p>To enable Chill Mode for your ring, please follow the steps below:</p>
            <ul>
                <li>Click on the ring icon on the top right of the ring homepage</li>
                <li>Click on Choose a Battery Usage Mode</li>
                <li>Toggle Chill mode</li>
            </ul>
            <p>After this, the user needs to observe the battery drain from 100% to 10%, while keeping chill mode enabled - and let us know when down to 10%. Then we check the rate of drain and for how many days the battery lasted.</p>
            <p>Step 5: In case of a high BDR post the above steps, we replace the ring.</p>
            <p>Battery Health Assessment</p>
            <p>All users must have 48 hours of Chill Mode data for accurate assessment (the dashboard shows "Calibrating" status until sufficient data collected)</p>
            <p>Battery health indicators:</p>
            <p>BDR (Battery Dissipation Rate) % drain per hour</p>
            <p>Good BDR: ≤1.0 (equals ≥4 days)</p>
            <p>Optimal BDR: ≤0.5 (equals ≥8 days)</p>
            <p>Replacement threshold: any user that has ≤4 days battery life</p>
            <p>(48 hours BDR battery life] after using Chill Mode for at least 48 hours warrants a replacement.</p>
            <p>If a customer is already frustrated with troubleshooting steps and is not on the latest firmware, please do not ask them to update it.If the customer has already tried the TSW and is clearly irritated:</p>
            <ul>
                <li>If within policy: Proceed with a replacement.</li>
                <li>If outside policy: Suggest a trade-in or Wabi ring, whichever the customer is more comfortable with.</li>
            </ul>
            <p>Please avoid suggesting any new firmware updates or additional TSW steps for already frustrated customers</p>
            <p>Note for the team: We now also have a dedicated dashboard for Battery troubleshooting. We filter out individual Ring details and share the resolution as suggested by the Dashboard</p>
            <p>Yellow/Flowchart</p>
            <p>Yellow Bot Flow</p>

            <h3>Ring Frequent Disconnection</h3>
            <h4>Case Identifier</h4>
            <p>The ring frequently disconnects from the app: There are episodes of the ring disconnecting and reconnecting intermittently at rapid intervals</p>

            <h4>Resolution</h4>
            <p>STEP 1: Check Firmware</p>
            <p>Verify if the Ring is on the latest firmware.</p>
            <p>If the user is not on the latest firmware: Push the user to the latest firmware</p>
            <p>Macro [Pushto_Zephyr]</p>
            <p>I have pushed the latest firmware to your ring. Please quit the app completely, and reopen the app in a while. If you don't see the Firmware Update pop-up, it should appear within the next few hours (If it doesn't, please head to ring battery view > scroll down > "check for firmware update"). Once it does, follow the prompts and update your firmware. Once your firmware has been updated, please observe for a while. You shouldn't face these issues anymore :)</p>
            <p>Let us know how this goes or if you need any help!</p>
            <p>If the user is already on the latest firmware we directly Proceed to Step 2.</p>
            <p>STEP 2:</p>
            <p>Macro Name: [Frequent_RingDisconnection]</p>
            <p>Can you toggle your Bluetooth off and on, then restart your phone and then check whether the ring is connecting? Then let's keep it under observation for a few hours? You can get back to me, I will be here to help you and keep this chat open.</p>
            <p>Feel free to get back to me anytime—I will be here to assist you. Keeping this chat open for your convenience.</p>
            <p>STEP 3:</p>
            <p>If even after all these steps, if the issue still persists we replace the ring.</p>

            <h3>Ring not Connecting/Advertising</h3>
            <h4>Case Identifier</h4>
            <p>The user is trying to pair their ring: The ring is experiencing an issue with advertising and pairing with the app.</p>

            <h4>Resolution</h4>
            <p>Step 1:</p>
            <p>Macro Name: #ConnectionTS1</p>
            <p>Let's rule out the basics:</p>
            <ul>
                <li>Turn Off Power Saver Mode on Your Phone: Low battery (below 20%) can degrade Bluetooth performance. Charge your phone to maintain a stable connection.</li>
                <li>Disconnect Unused Bluetooth Devices: Having too many connected devices can block new connections. Disconnect unused devices from your phone's Bluetooth settings.</li>
            </ul>
            <p>Then, continue troubleshooting with these:</p>
            <ul>
                <li>Switch Off Wi-Fi Temporarily: Wi-Fi can occasionally interfere with Bluetooth. Turn it off briefly to improve connectivity.</li>
                <li>Toggle Bluetooth Off/On: Turn Bluetooth off, wait a few seconds, then turn it back on to refresh the connection.</li>
                <li>Complete a Bluetooth Reset: Keep the Ring on the charger → Turn off Bluetooth → Force-close the app → Re-enable Bluetooth → Remove the Ring from paired devices → Re-pair it via the Ultrahuman app.</li>
                <li>Try a Different Cable or Adapter: Faulty USB-C cables or power adapters can disrupt charging and connectivity. Switch both the cable and the power source (preferably a wall socket-based adapter).</li>
                <li>Reinstall the Ultrahuman App: Uninstall and reinstall the app from the App Store to fix persistent issues.</li>
            </ul>
            <p>Step 2:</p>
            <p>Macro Name: #ConnectionTS2</p>
            <p>As a last resort, we'll perform a Battery Drain Reset. This step ensures the ring undergoes a complete hardware reset, clearing its internal state and helping resolve issues related to Bluetooth connectivity or advertising.</p>
            <ol>
                <li>We have triggered the battery drain reset for you. You should now see a banner with a timer on the Ring tab of your app. This timer estimates the time it will take for the battery to fully drain. Note: If you don't see the banner, try killing and relaunching the app.</li>
                <li>Please do not place the Ring on the charger until the battery is completely drained, or it will interrupt the reset process.</li>
                <li>Once the battery is fully drained, you'll receive a push notification prompting you to reconnect. Please charge the ring for at least 30 minutes before you reattempt connecting the ring.</li>
            </ol>
            <p>If the ring still does not connect after completing this step, please let us know, and we will assist you further.</p>
            <p>Step 3: Replace if the above steps don't work, we replace</p>
            <p>Connection is replacement: The ring is advertising but not connecting to the app</p>
            <p>Not advertising replacement: The ring is not advertising on the Bluetooth settings</p>
            <p>If a customer is already frustrated with troubleshooting steps and is not on the latest firmware, please do not ask them to update it.If the customer has already tried the TSW and is clearly irritated:</p>
            <ul>
                <li>If within policy: Proceed with a replacement.</li>
                <li>If outside policy: Suggest a trade-in or Wabi ring, whichever the customer is more comfortable with.</li>
            ...
            <h3>Ring only connects on the charger</h3>
            <h4>Case Identifier</h4>
            <p>The ring connects to the app only when it is on the charger. Once removed from the charger, it disconnects.</p>

            <h4>Resolution</h4>
            <p>Ask for ring images and check for battery bulges or damage near the sensor, if there is damage replace it directly.</p>
            <p>If there is no damage:</p>
            <p>Step 1: Check Firmware</p>
            <p>Verify if the Ring is on the latest firmware. If not updated, then push to the latest firmware:</p>
            <p>Macro [Pushto_Zephyr]</p>
            <p>I have pushed the latest firmware to your ring. Please quit the app completely, and reopen the app in a while. If you don't see the Firmware Update pop-up, it should appear within the next few hours (If it doesn't, please head to ring battery view > scroll down > "check for firmware update"). Once it does, follow the prompts and update your firmware. Once your firmware has been updated, please observe for a while. You shouldn't face these issues anymore :)</p>
            <p>Let us know how this goes or if you need any help!</p>
            <p>Step 2: Factory Reset</p>
            <p>Macro [Zephyr_New_FR]</p>
            <p>Please go ahead and factory reset your ring here (Ring battery view > scroll down > factory reset > follow the prompts). Once this is done, keep the ring on the charger and you will notice a green LED light when the ring is placed on the charger. At this point, the ring will disconnect from the phone which is expected behaviour so don't worry! Once you see the green light, remove the ring from the charger and connect the ring.</p>
            <p>You can click here and view the process to factory reset the ring.</p>
            <p>After this, your ring should get connected and you shouldn't face these issues :)</p>
            <p>Let us know if you need any help!</p>
            <p>Keep the Ring on the charger for 15 minutes after the reset. After 15 minutes, observe the ring until the end of the day.</p>
            <p>Step 3: Issue persists, then replace</p>
            <ul>
                <li>A: In case of observed hardware damage, replace the ring under hardware damage reasoning.</li>
                <li>B: In case there are no observed damages, replace the ring under battery failure reasoning.</li>
            </ul>

            <h3>Ring State 10- No contact detected</h3>
            <h4>Case Identifier</h4>
            <p>The ring is not detecting any contact with the finger: The user's heart rate and skin temperature data do not appear on their homepage.</p>
            <p>Backend identifier: Ring state 10.</p>

            <h4>Resolution</h4>
            <p>Ring fit Check</p>
            <p>We check the Fit of the ring to ensure that the sensors are oriented properly</p>
            <p>Macro: [#HR9_Incorrect_Sleep_TS1]</p>
            <ul>
                <li>Could you please confirm the below details:</li>
                <li>1. Can you confirm how the ring fits you? The ring can be worn on the index, middle, or ring finger and should fit snugly (not too tight or too loose). To remove the ring, push from the bottom and slide it off. For accurate readings, ensure the sensors, marked by a small bulge on the inner side of the ring emitting green lights, are facing the inner side of your palm. Please refer to the attached image for clarification.</li>
                <li>2. Could you share a close-up image of the sensors on the ring? This would be the area with the small bump on the inner side of the ring.</li>
            </ul>
            <p>Ring Firmware Check</p>
            <p>Macro: [#Pushto_Zephyr]</p>
            <p>We check the firmware version and upgrade to the relevant version + push a soft reset</p>
            <p>We run all checks and then basis the findings we move to Step 3, in case the issue persists</p>
            <p>Recommend a factory reset</p>
            <p>Macro: [Zephyr_New_FR]</p>
            ...
            <p>After this, your ring should get connected and you shouldn't face these issues :)</p>
            <p>Let us know if you need any help!</p>
            <p>Recommend workout mode</p>
            <p>Macro: [#Zephyr_breathwork_workout]</p>
            <p>Can you please try enabling the workout mode on the app for a few minutes and wait till your data populates? This should fix the issue. You can then observe going forward - the data should sync fine :)</p>
            <p>Do let us know if your data doesn't populate here!</p>
            <p>Step 5: If nothing works, replace the ring.</p>

            <h3>Ring Step 0- No steps picked</h3>
            <h4>Case Identifier</h4>
            <p>The user's step count does not update: No step data is reflected on the Movement Index.</p>

            <h4>Resolution</h4>
            <p>Step 1: Check Firmware</p>
            <p>Verify if the Ring is on the latest firmware. If not, push the latest firmware update.</p>
            <p>Macro Name [Pushto_Zephyr]</p>
            <p>I have pushed the latest firmware to your Ring. Please quit the app completely and reopen it after a while. If you don't see the firmware update pop-up immediately, it should appear within the next few hours. If not, go to Ring Battery View → Scroll down → Tap Check for Firmware Update. Follow the prompts to complete the update.</p>
            <p>Once your firmware is updated, please observe the device for a while. You shouldn't face these issues anymore.</p>
            <p>Let us know how it goes or if you need any help!"</p>
            <p>Once updated, charge the Ring for 15 minutes. Observe its behavior for a couple of days.</p>
            <p>Note: In case the user is already on the latest firmware, We directly move to step 2</p>
            <p>Step 2: If the Issue Persists</p>
            <p>Please let us know. We will trigger a soft reset command from the backend.</p>
            <p>Macro Name [Soft_Rest]</p>
            <p>We have triggered a soft reset for you from the backend. Kindly close and reopen the app in a minute and observe the Ring's behavior."</p>
            <p>Step 3: If the Soft Reset Doesn't Work. Please perform a factory reset</p>
            <p>Macro Name [Zephyr_New_FR]</p>
            <p>Please go ahead and factory reset your ring here (Ring battery view > scroll down > factory reset > follow the prompts). Once this is done, keep the ring on the charger and you will notice a green LED light when the ring is placed on the charger. At this point, the ring will disconnect from the phone which is expected behavior so don't worry! Once you see the green light, remove the ring from the charger and connect the ring.</p>
            <p>You can click here and view the process to factory reset the ring.</p>
            <p>After this, your ring should get connected and you shouldn't face these issues :)</p>
            <p>Let us know if you need any help!</p>
            <p>Step 4: Post this if the issue persists, please replace the ring.</p>

            <h3>HR Sensor Failure: Constant Red light on the ring</h3>
            <h4>Case Identifier</h4>
            <p>The ring has a constant red light flashing from the sensor</p>

            <h4>Resolution</h4>
            <p>STEP 1: Factory Reset The Ring</p>
            <p>Macro Name [Zephyr_New_FR]</p>
            <p>Please go ahead and factory reset your ring here (Ring battery view > scroll down > factory reset > follow the prompts). Once this is done, keep the ring on the charger and you will notice a green LED light when the ring is placed on the charger. At this point, the ring will disconnect from the phone which is expected behavior so don't worry! Once you see the green light, remove the ring from the charger and connect the ring.</p>
            <p>You can click here and view the process to factory reset the ring.</p>
            <p>After this, your ring should get connected and you shouldn't face these issues :)</p>
            <p>Let us know if you need any help!</p>
            <p>STEP 2: If the red light is still visible after step 1, we replace the ring.</p>

            <h3>Incorrect Movement Index</h3>
            <h4>Case Identifier</h4>
            <p>Discrepancy in the step count: The ring is either underreporting or overreporting the step count, or there is a discrepancy when comparing the step counts across different wearables.</p>

            <h4>Resolution</h4>
            <p>Step 1: Ring fit check</p>
            <p>Check the fit of the ring and the firmware version→ upgrade to the latest version + push a soft reset</p>
            <p>Macro [#HR9_Incorrect_Sleep_TS1]</p>
            <ul>
                <li>Could you please confirm the below details:</li>
                <li>1. Can you confirm how the ring fits you? The ring can be worn on the index, middle, or ring finger and should fit snugly (not too tight or too loose). To remove the ring, push from the bottom and slide it off. For accurate readings, ensure the sensors, marked by a small bulge on the inner side of the ring emitting green lights, are facing the inner side of your palm. Please refer to the attached image for clarification.</li>
            ...
            <p>Step 2: Ring Firmware Check</p>
            <p>We check the firmware version and upgrade to the relevant version</p>
            <p>Macro [#Pushto_Zephyr]</p>
            <p>I have pushed the latest firmware to your ring. Please quit the app completely, and reopen the app in a while. If you don't see the Firmware Update pop-up, it should appear within the next few hours (If it doesn't, please head to ring battery view > scroll down > "check for firmware update"). Once it does, follow the prompts and update your firmware. Once your firmware has been updated, please observe for a while. You shouldn't face these issues anymore :)</p>
            <p>Let us know how this goes or if you need any help!</p>
            <p>STEP 3: If the user is on the latest firmware, check the scale of discrepancy by asking for the relevant data points (in case of comparison against any other wearable) and communicate the users the</p>
            <p>OMS Actions</p>
            <p>Ring steps 0</p>
            <p>This is solved by the wizard flow here:</p>
            <p>Step data incorrect</p>
            <p>Check with the user if they are comparing this with another wearable</p>
            <p>If the wearable vs the ring's step count is under 10%, we can inform the user that each wearable tracks steps data according to their own algorithm and hence, 10% diffrence is within the margin of error</p>
            <p>In case the step count is way off, check for fit and update firmware + soft reset on backend</p>
            <p>In case the step count does not improve, flag this to tech</p>
            <p>Flowchart</p>
            <p>https://miro.com/welcomeonboard/OE1takpKM3hsOGptSVNjblFCbVJHazZnU2lvSnl0UFVVeTlXSTNWa1FxNXhrWUpIRHpTcU</p>
            <p>share_link_id=810409693746</p>

            <h3>Incorrect Sleep data</h3>
            <h4>Case Identifier</h4>
            <p>The user may face one of the following issues:</p>
            <ul>
                <li>The sleep index is missing for the day.</li>
                <li>The sleep has been incorrectly detected by the ring.</li>
            </ul>
            ...
            <ul>
                <li>Could you please confirm the below details:</li>
                <li>1. Can you confirm how the ring fits you? The ring can be worn on the index, middle, or ring finger and should fit snugly (not too tight or too loose). To remove the ring, push it from the bottom and slide it off. For accurate readings, ensure the sensors, marked by a small bulge on the inner side of the ring emitting green lights, are facing the inner side of your palm. Please refer to the attached image for clarification.</li>
                <li>2. Could you share a close-up image of the sensors on the ring? This would be the area with the small bump on the inner side of the ring.</li>
            </ul>
            <p>Note: Once the user confirms this, the agent conducts the checks backend to check if all the sleep metrics are working fine.</p>
            <p>STEP 2: Ring Firmware Check</p>
            <p>We check the firmware version and upgrade to the relevant version + push a soft reset</p>
            <p>We run all checks and then basis the findings we move to Step 3, in case the the issue persists</p>
            <p>OMS Actions:</p>
            <ul>
                <li>Ring did not capture data: We do this, by going to : Ring data → Sleep indices and pull the data for the same day. We are looking for a non "-1" reading as that indicates no sleep data captured. If the sleep data was not captured, check the ring's battery. If you see that the ring's battery is close to zero, we can inform the user here that the ring can only capture data as long as it has charge. Since the ring died before the data got synced with the phone, the sleep data was lost. We can then inform the user to ensure the ring has sufficient charge regularly. In case the user's battery did not have any issues, check the ring state data to see for any abnormalities. Normally, the ring should show ≥50 which indicates that the data is getting collected. If ring state is also looking normal, check if the record indice count went to 0. This indicates a firmware crash which can also wipe the data. If yes, for any of the above conditions, we can ask the user to update the firmware and perform a soft reset as well.</li>
                <li>Ring data captured is incorrect: Ring data → Sleep diagnosis → Enter the user's detail for the day and check the sleep start and end times. Look for high amount of motion. Check with the user if they had a disturbed night of sleep or if the ring fits the user well. If not, push the ask the user to update the firmware and perform a soft reset as well. In case the sleep data does not improve, flag this to tech</li>
            </ul>
            <p>STEP 2: Flag to tech team on slack</p>
            <p>Flowchart</p>
            <p>https://miro.com/welcomeonboard/OE1takpKM3hsOGptSVNjblFCbVJHazZnU2lvSnl0UFVVeTlXSTNWa1FxNXhrWUpIRHpTcU</p>
            <p>share_link_id=810409693746</p>
        `
